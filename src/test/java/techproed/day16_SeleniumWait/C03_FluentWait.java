...
public class C03_FluentWait extends TestBase {
    ...
    public void test01() {
        ...
        wait.withTimeout(Duration.ofSeconds(20)).//-->FluentWait icin max bekleme süresini berlirtir.
    ...
    public void test02() {
        ...
        //Hello World! Yazının sitede oldugunu test et
        WebElement helloWorldText = driver.findElement(By.xpath("(//h4)[2]"));
        new FluentWait<>(driver).withTimeout(Duration.ofSeconds(200)).pollingEvery(Duration.ofMillis(200)).
    ...
    public void test03() {
        ...
        //Hello World! Yazının sitede oldugunu test et
        WebElement helloWorldText = driver.findElement(By.xpath("(//h4)[2]"));
    Wait<WebDriver> wait=new FluentWait<>(driver).withTimeout(Duration.ofSeconds(200)).pollingEvery(Duration.ofMillis(200));
    wait.until(ExpectedConditions.visibilityOf(helloWorldText));
    }

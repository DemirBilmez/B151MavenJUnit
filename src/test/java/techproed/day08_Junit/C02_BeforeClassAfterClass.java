...
public class C02_BeforeClassAfterClass {
    /*@BeforeClass
    class'da en once calısan methoddur.
    @AfterClass
    class'da en son calısan methoddur.
    ...
    */
    ...
    public static void beforeClass() throws Exception {
        System.out.println("classta en önce calisan method, bir kez calisir");
    }

    @AfterClass
    public static void afterClass() throws Exception {
        System.out.println("classta en son calisan method, bir kez calisir");
    }
